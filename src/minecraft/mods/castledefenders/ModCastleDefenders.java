...
public class ModCastleDefenders extends GollumMod {
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		this.config = new ConfigCastleDefender(this);
	...
	public void initItems () {
		...
		this.itemMedallion = factory.create(new ItemMedallion(this.config.medallionID), "Medallion", this);
	}
	...
	public void initBlocks () {
		...
		// Création des blocks
		this.blockKnight     = factory.create (new BlockKnight(this.config.blockKnightID), "BlockKnight"            ).setHardness(2.0F).setResistance(5.0F);
		this.blockKnight2    = factory.create (new BlockKnight2(this.config.blockKnight2ID), "BlockKnight2"         ).setHardness(2.0F).setResistance(5.0F);
		this.blockArcher     = factory.create (new BlockArcher(this.config.blockArcherID), "BlockArcher"            ).setHardness(2.0F).setResistance(5.0F);
		this.blockArcher2    = factory.create (new BlockArcher2(this.config.blockArcher2ID), "BlockArcher2"         ).setHardness(2.0F).setResistance(5.0F);
		this.blockMerc       = factory.create (new BlockMerc(this.config.blockMercID), "BlockMerc"                  ).setHardness(2.0F).setResistance(5.0F);
		this.blockMercArcher = factory.create (new BlockMercArcher(this.config.blockMercArcherID), "BlockMercArcher").setHardness(2.0F).setResistance(5.0F);
		this.blockMage       = factory.create (new BlockMage(this.config.blockMageID), "BlockMage"                  ).setHardness(2.0F).setResistance(5.0F);
		this.blockHealer     = factory.create (new BlockHealer(this.config.blockHealerID), "BlockHealer"            ).setHardness(2.0F).setResistance(5.0F);
		this.blockEKnight    = factory.create (new BlockEKnight(this.config.blockEKnightID), "BlockEKnight"         ).setHardness(2.0F).setResistance(5.0F);
		this.blockEArcher    = factory.create (new BlockEArcher(this.config.blockEArcherID), "BlockEArcher"         ).setHardness(2.0F).setResistance(5.0F);
		this.blockEMage      = factory.create (new BlockEMage(this.config.blockEMageID), "BlockEMage"               ).setHardness(2.0F).setResistance(5.0F);
