...
public class ClientProxyCastleDefenders extends CommonProxyCastleDefenders {
	...
	public void registerRenderers() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityMerc.class   , new RenderCastleDefenders(new ModelBiped(), 0.5F, "Merc"));
		RenderingRegistry.registerEntityRenderingHandler(EntityArcherM.class, new RenderCastleDefenders(new ModelBiped(), 0.5F, "ArcherM"));
		RenderingRegistry.registerEntityRenderingHandler(EntityHealer.class , new RenderCastleDefenders(new ModelBiped(), 0.5F, "Healer"));
