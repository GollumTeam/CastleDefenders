...
public class TileEntityBlockArcherM extends TileEntity
{
    public int delay = -1;
    private String mobID = "Merc Archer";
        ...
        if (this.anyPlayerInRange())
        {
            ...
            else
            {
                ...
                for (int var1 = 0; var1 < this.spawnCount; ++var1)
                {
                    ...
                    int var3 = this.worldObj.getEntitiesWithinAABB(var2.getClass(), AxisAlignedBB.getAABBPool().getAABB((double)this.xCoord, (double)this.yCoord, (double)this.zCoord, (double)(this.xCoord + 1), (double)(this.yCoord + 1), (double)(this.zCoord + 1)).expand(8.0D, 4.0D, 8.0D)).size();
