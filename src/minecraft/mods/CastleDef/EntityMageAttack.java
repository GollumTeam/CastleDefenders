...
public class EntityMageAttack extends EntityAIBase
{
    World worldObj;
    ...
    public EntityMageAttack(EntityLiving var1, Class var2, float var3, boolean var4)
    {
        this(var1, var3, var4);
        this.classTarget = var2;
    }

    public EntityMageAttack(EntityLiving var1, float var2, boolean var3)
    {
        this.doattack = 0;
        this.attackTick = 0;
        this.attacker = var1;
    ...
    public void updateTask()
    {
        ...
        if (var8 == 1)
        {
            this.worldObj.spawnEntityInWorld(new EntityLightningBolt(this.worldObj, this.entityTarget.posX, this.entityTarget.posY, this.entityTarget.posZ));
        }
    }
}
