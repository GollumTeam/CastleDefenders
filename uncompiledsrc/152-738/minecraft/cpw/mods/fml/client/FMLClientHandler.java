...
public class FMLClientHandler implements IFMLSidedHandler
{
    ...
    {
        this.client.displayCrashReport(new CrashReport(var1, var2));
    ...
    public void finishMinecraftLoading()
    {
        if (this.modsMissing == null && this.wrongMC == null && this.customError == null && this.dupesFound == null && this.modSorting == null)
        {
            ...
            this.loading = false;
            KeyBindingRegistry.instance().uploadKeyBindingsToGame(this.client.gameSettings);
        }
    }
    ...
    public void onInitializationComplete()
    {
        ...
        {
            this.client.displayGuiScreen(new GuiWrongMinecraft(this.wrongMC));
        }
        else if (this.modsMissing != null)
        {
            this.client.displayGuiScreen(new GuiModsMissing(this.modsMissing));
        }
        else if (this.dupesFound != null)
        {
            this.client.displayGuiScreen(new GuiDupesFound(this.dupesFound));
        }
        else if (this.modSorting != null)
        {
            this.client.displayGuiScreen(new GuiSortingProblem(this.modSorting));
        }
        else if (this.customError != null)
        {
            this.client.displayGuiScreen(new GuiCustomModLoadingErrorScreen(this.customError));
        }
        else
        {
    ...
    {
        if (this.client.thePlayer == var1 && var2 != null)
        {
            this.client.displayGuiScreen(var2);
        }
    }
    ...
    {
        WorldClient var3 = this.client.theWorld;
        ...
        try
        {
            ...
            var5.serverPosX = var2.rawX;
            var5.serverPosY = var2.rawY;
            var5.serverPosZ = var2.rawZ;

            if (var5 instanceof IThrowableEntity)
            {
                Object var10 = this.client.thePlayer.entityId == var2.throwerId ? this.client.thePlayer : var3.getEntityByID(var2.throwerId);
                ((IThrowableEntity)var5).setThrower((Entity)var10);
            }

            if (var2.metadata != null)
            {
                var5.getDataWatcher().updateWatchedObjectsFromList(var2.metadata);
            }

            if (var2.throwerId > 0)
            {
                var5.setVelocity(var2.speedScaledX, var2.speedScaledY, var2.speedScaledZ);
            }
            ...
            var3.addEntityToWorld(var2.entityId, var5);
            return var5;
        }
    ...
    {
        Entity var2 = this.client.theWorld.getEntityByID(var1.entityId);

        if (var2 != null)
        {
            var2.serverPosX = var1.serverX;
            var2.serverPosY = var1.serverY;
            var2.serverPosZ = var1.serverZ;
        }
        else
        {
    ...
    public void sendPacket(Packet var1)
    {
        ...
        {
            this.client.thePlayer.sendQueue.addToSendQueue(var1);
        }
    }

    public void displayMissingMods(ModMissingPacket var1)
    {
        this.client.displayGuiScreen(new GuiModsMissingForServer(var1));
    }
    ...
    {
        ((NetClientHandler)var1).fmlPacket131Callback(var2);
    }

    public void setClientCompatibilityLevel(byte var1)
    {
        NetClientHandler.setConnectionCompatibilityLevel(var1);
    }
    ...
    public void warnIDMismatch(MapDifference var1, boolean var2)
    {
        ...
        this.client.displayGuiScreen(var3);
    }
    ...
    public void disconnectIDMismatch(MapDifference var1, NetHandler var2, INetworkManager var3)
    {
        ...
        if (var4)
        {
            ((NetClientHandler)var2).disconnect();
            GuiConnecting.forceTermination((GuiConnecting)this.client.currentScreen);
    ...
    {
        return this.client.currentScreen != null && this.client.currentScreen.getClass().equals(var1);
    }
}
