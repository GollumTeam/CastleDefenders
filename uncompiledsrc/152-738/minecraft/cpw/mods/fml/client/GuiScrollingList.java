...
public abstract class GuiScrollingList
{
    ...
    public void actionPerformed(GuiButton var1)
    {
        if (var1.enabled)
        {
            if (var1.id == this.scrollUpActionId)
            {
                this.scrollDistance -= (float)(this.slotHeight * 2 / 3);
                this.initialMouseClickY = -2.0F;
                this.applyScrollLimits();
            }
            else if (var1.id == this.scrollDownActionId)
            {
                this.scrollDistance += (float)(this.slotHeight * 2 / 3);
                this.initialMouseClickY = -2.0F;
                this.applyScrollLimits();
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        var18.addVertexWithUV((double)this.left, (double)this.bottom, 0.0D, (double)((float)this.left / var19), (double)((float)(this.bottom + (int)this.scrollDistance) / var19));
        var18.addVertexWithUV((double)this.right, (double)this.bottom, 0.0D, (double)((float)this.right / var19), (double)((float)(this.bottom + (int)this.scrollDistance) / var19));
        var18.addVertexWithUV((double)this.right, (double)this.top, 0.0D, (double)((float)this.right / var19), (double)((float)(this.top + (int)this.scrollDistance) / var19));
        var18.addVertexWithUV((double)this.left, (double)this.top, 0.0D, (double)((float)this.left / var19), (double)((float)(this.top + (int)this.scrollDistance) / var19));
        var18.draw();
        ...
        for (var10 = 0; var10 < var4; ++var10)
        {
            ...
            if (var12 <= this.bottom && var12 + var11 >= this.top)
            {
                if (this.field_25123_p && this.isSelected(var10))
                {
                    ...
                    var18.addVertexWithUV((double)var7, (double)(var12 + var11 + 2), 0.0D, 0.0D, 1.0D);
                    var18.addVertexWithUV((double)var8, (double)(var12 + var11 + 2), 0.0D, 1.0D, 1.0D);
                    var18.addVertexWithUV((double)var8, (double)(var12 - 2), 0.0D, 1.0D, 0.0D);
                    var18.addVertexWithUV((double)var7, (double)(var12 - 2), 0.0D, 0.0D, 0.0D);
                    var18.setColorOpaque_I(0);
                    var18.addVertexWithUV((double)(var7 + 1), (double)(var12 + var11 + 1), 0.0D, 0.0D, 1.0D);
                    var18.addVertexWithUV((double)(var8 - 1), (double)(var12 + var11 + 1), 0.0D, 1.0D, 1.0D);
                    var18.addVertexWithUV((double)(var8 - 1), (double)(var12 - 1), 0.0D, 1.0D, 0.0D);
                    var18.addVertexWithUV((double)(var7 + 1), (double)(var12 - 1), 0.0D, 0.0D, 0.0D);
                    var18.draw();
        ...
        var18.addVertexWithUV((double)this.left, (double)(this.top + var16), 0.0D, 0.0D, 1.0D);
        var18.addVertexWithUV((double)this.right, (double)(this.top + var16), 0.0D, 1.0D, 1.0D);
        ...
        var18.setColorRGBA_I(0, 0);
        var18.addVertexWithUV((double)this.right, (double)(this.bottom - var16), 0.0D, 1.0D, 0.0D);
        var18.addVertexWithUV((double)this.left, (double)(this.bottom - var16), 0.0D, 0.0D, 0.0D);
        var18.draw();
        var12 = this.getContentHeight() - (this.bottom - this.top - 4);
        ...
        if (var12 > 0)
        {
            ...
            var18.addVertexWithUV((double)var5, (double)(var15 + var11), 0.0D, 0.0D, 1.0D);
            var18.addVertexWithUV((double)var6, (double)(var15 + var11), 0.0D, 1.0D, 1.0D);
            var18.addVertexWithUV((double)var6, (double)var15, 0.0D, 1.0D, 0.0D);
            var18.addVertexWithUV((double)var5, (double)var15, 0.0D, 0.0D, 0.0D);
            var18.draw();
            var18.startDrawingQuads();
            var18.setColorRGBA_I(12632256, 255);
            var18.addVertexWithUV((double)var5, (double)(var15 + var11 - 1), 0.0D, 0.0D, 1.0D);
            var18.addVertexWithUV((double)(var6 - 1), (double)(var15 + var11 - 1), 0.0D, 1.0D, 1.0D);
            var18.addVertexWithUV((double)(var6 - 1), (double)var15, 0.0D, 1.0D, 0.0D);
            var18.addVertexWithUV((double)var5, (double)var15, 0.0D, 0.0D, 0.0D);
            var18.draw();
        }
    ...
    private void overlayBackground(int var1, int var2, int var3, int var4)
    {
        ...
        var5.addVertexWithUV((double)this.listWidth + 30.0D, (double)var2, 0.0D, (double)((float)(this.listWidth + 30) / var6), (double)((float)var2 / var6));
        var5.setColorRGBA_I(4210752, var3);
        var5.addVertexWithUV((double)this.listWidth + 30.0D, (double)var1, 0.0D, (double)((float)(this.listWidth + 30) / var6), (double)((float)var1 / var6));
