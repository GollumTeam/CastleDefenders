...
public class RenderingRegistry
{
    ...
    {
        RenderPlayer.armorFilenamePrefix = (String[])ObjectArrays.concat(RenderPlayer.armorFilenamePrefix, var0);
        RenderBiped.bipedArmorFilenamePrefix = RenderPlayer.armorFilenamePrefix;
        return RenderPlayer.armorFilenamePrefix.length - 1;
    }

    public static void registerEntityRenderingHandler(Class var0, Render var1)
    {
    ...
    public void renderInventoryBlock(RenderBlocks var1, Block var2, int var3, int var4)
    {
    ...
    public void loadEntityRenderers(Map var1)
    {
        ...
        while (var2.hasNext())
        {
            ...
            RenderingRegistry$EntityRendererInfo.access$100(var3).setRenderManager(RenderManager.instance);
        }
    }
}
