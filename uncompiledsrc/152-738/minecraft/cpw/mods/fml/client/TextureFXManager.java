...
public class TextureFXManager
{
    ...
    public BufferedImage loadImageFromTexturePack(RenderEngine var1, String var2) throws IOException
    {
        InputStream var3 = this.client.texturePackList.getSelectedTexturePack().getResourceAsStream(var2);
