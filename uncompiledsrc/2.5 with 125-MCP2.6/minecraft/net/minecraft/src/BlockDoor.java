...
public class BlockDoor extends Block
{
    ...
    {
        return (par1 & 8) == 0 ? blockMaterial != Material.iron ? Item.doorWood.shiftedIndex : Item.doorSteel.shiftedIndex : 0;
    }
    ...
    {
        return par3 < 255 ? par1World.isBlockSolidOnSide(par2, par3 - 1, par4, 1) && super.canPlaceBlockAt(par1World, par2, par3, par4) && super.canPlaceBlockAt(par1World, par2, par3 + 1, par4) : false;
    }
