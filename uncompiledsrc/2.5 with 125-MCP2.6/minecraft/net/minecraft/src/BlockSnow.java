...
public class BlockSnow extends Block
{
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4)
    {
        ...
        return i < 3 ? null : AxisAlignedBB.getBoundingBoxFromPool((double)par2 + minX, (double)par3 + minY, (double)par4 + minZ, (double)par2 + maxX, (float)par3 + 0.5F, (double)par4 + maxZ);
    }
    ...
    public boolean canPlaceBlockAt(World par1World, int par2, int par3, int par4)
    {
        ...
        return block == null || !block.isLeaves(par1World, par2, par3 - 1, par4) && !Block.blocksList[i].isOpaqueCube() ? false : par1World.getBlockMaterial(par2, par3 - 1, par4).blocksMovement();
    }
    ...
    {
        return par5 != 1 ? super.shouldSideBeRendered(par1IBlockAccess, par2, par3, par4, par5) : true;
    }
}
