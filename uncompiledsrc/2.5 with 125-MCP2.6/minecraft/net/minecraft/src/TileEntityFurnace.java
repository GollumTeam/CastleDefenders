...
public class TileEntityFurnace extends TileEntity implements IInventory, ISidedInventory
{
    ...
    private boolean canSmelt()
    {
        ...
        {
            int i = furnaceItemStacks[2].stackSize + itemstack.stackSize;
            return i <= getInventoryStackLimit() && i <= itemstack.getMaxStackSize();
        }
    }
    ...
    public static int getItemBurnTime(ItemStack par1ItemStack)
    {
        ...
        int j = ForgeHooks.getItemBurnTime(par1ItemStack);
        ...
        {
            return FMLCommonHandler.instance().fuelLookup(i, par1ItemStack.getItemDamageForDisplay());
        }
    }
