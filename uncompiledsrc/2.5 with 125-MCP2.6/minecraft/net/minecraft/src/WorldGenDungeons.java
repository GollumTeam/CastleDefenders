...
public class WorldGenDungeons extends WorldGenerator
{
        ...
        if (k >= 1 && k <= 5)
        {
            ...
            for (int j1 = 0; j1 < 2; j1++)
            {
                ...
                for (int i2 = 0; i2 < 3; i2++)
                {
                    ...
                    int i3 = (par5 + par2Random.nextInt(j * 2 + 1)) - j;

                    if (!par1World.isAirBlock(l2, par4, i3))
                    {
                        continue;
                    }
                    ...
                    if (par1World.getBlockMaterial(l2 - 1, par4, i3).isSolid())
                    {
                        j3++;
                    }
                    ...
                    if (par1World.getBlockMaterial(l2, par4, i3 - 1).isSolid())
                    {
                        j3++;
                    }
                    ...
                    par1World.setBlockWithNotify(l2, par4, i3, Block.chest.blockID);
                    TileEntityChest tileentitychest = (TileEntityChest)par1World.getBlockTileEntity(l2, par4, i3);
                    ...
                    do
                    {
                        if (k3 >= MinecraftForge.getDungeonLootTries())
                        {
                            break label0;
                        }

                        ItemStack itemstack = MinecraftForge.getRandomDungeonLoot(par2Random);
    ...
    private ItemStack pickCheckLootItem(Random par1Random)
    {
        ...
        return i != 0 ? i != 1 ? i != 2 ? i != 3 ? i != 4 ? i != 5 ? i != 6 ? i != 7 || par1Random.nextInt(100) != 0 ? i != 8 || par1Random.nextInt(2) != 0 ? i != 9 || par1Random.nextInt(10) != 0 ? i != 10 ? null : new ItemStack(Item.dyePowder, 1, 3) : new ItemStack(Item.itemsList[Item.record13.shiftedIndex + par1Random.nextInt(2)]) : new ItemStack(Item.redstone, par1Random.nextInt(4) + 1) : new ItemStack(Item.appleGold) : new ItemStack(Item.bucketEmpty) : new ItemStack(Item.silk, par1Random.nextInt(4) + 1) : new ItemStack(Item.gunpowder, par1Random.nextInt(4) + 1) : new ItemStack(Item.wheat, par1Random.nextInt(4) + 1) : new ItemStack(Item.bread) : new ItemStack(Item.ingotIron, par1Random.nextInt(4) + 1) : new ItemStack(Item.saddle);
    }
    ...
    private String pickMobSpawner(Random par1Random)
    {
        ...
        return i != 0 ? i != 1 ? i != 2 ? i != 3 ? "" : "Spider" : "Zombie" : "Zombie" : "Skeleton";
    }
}
