...
public class EntityList
{
    ...
    {
        Class class1 = (Class)IDtoClassMapping.get(Integer.valueOf(par0));
        return class1 == null ? null : (String)classToStringMapping.get(class1);
    }

    public static void addNewEntityListMapping(Class class1, String s, int i)
    {
        addMapping(class1, s, i);
    }

    public static void addNewEntityListMapping(Class class1, String s, int i, int j, int k)
    {
        addMapping(class1, s, i, j, k);
    }

    public static Map getEntityToClassMapping()
    {
