...
public class RenderPlayer extends RenderLiving
{
    ...
    protected void renderSpecials(EntityPlayer par1EntityPlayer, float par2)
    {
        ...
        if (itemstack != null && itemstack.getItem().shiftedIndex < 256)
        {
            ...
            IItemRenderer iitemrenderer = MinecraftForgeClient.getItemRenderer(itemstack, forge.IItemRenderer.ItemRenderType.EQUIPPED);
            boolean flag = iitemrenderer != null && iitemrenderer.shouldUseRenderHelper(forge.IItemRenderer.ItemRenderType.EQUIPPED, itemstack, forge.IItemRenderer.ItemRendererHelper.BLOCK_3D);

            if (flag || RenderBlocks.renderItemIn3d(Block.blocksList[itemstack.itemID].getRenderType()))
            {
                float f7 = 0.625F;
        ...
        if (par1EntityPlayer.username.equals("deadmau5") && loadDownloadableImageTexture(par1EntityPlayer.skinUrl, (String)null))
        {
            for (int i = 0; i < 2; i++)
            {
                float f8 = (par1EntityPlayer.prevRotationYaw + (par1EntityPlayer.rotationYaw - par1EntityPlayer.prevRotationYaw) * par2) - (par1EntityPlayer.prevRenderYawOffset + (par1EntityPlayer.renderYawOffset - par1EntityPlayer.prevRenderYawOffset) * par2);
                float f = par1EntityPlayer.prevRotationPitch + (par1EntityPlayer.rotationPitch - par1EntityPlayer.prevRotationPitch) * par2;
                GL11.glPushMatrix();
        ...
        if (loadDownloadableImageTexture(par1EntityPlayer.playerCloakUrl, (String)null))
        {
            GL11.glPushMatrix();
            ...
            float f5 = par1EntityPlayer.prevRenderYawOffset + (par1EntityPlayer.renderYawOffset - par1EntityPlayer.prevRenderYawOffset) * par2;
            double d3 = MathHelper.sin((f5 * (float)Math.PI) / 180F);
            double d4 = -MathHelper.cos((f5 * (float)Math.PI) / 180F);
        ...
        if (itemstack1 != null)
        {
            ...
            IItemRenderer iitemrenderer1 = MinecraftForgeClient.getItemRenderer(itemstack1, forge.IItemRenderer.ItemRenderType.EQUIPPED);
            boolean flag1 = iitemrenderer1 != null && iitemrenderer1.shouldUseRenderHelper(forge.IItemRenderer.ItemRenderType.EQUIPPED, itemstack1, forge.IItemRenderer.ItemRendererHelper.BLOCK_3D);

            if (itemstack1.itemID < 256 && (flag1 || RenderBlocks.renderItemIn3d(Block.blocksList[itemstack1.itemID].getRenderType())))
            {
                float f1 = 0.5F;
            ...
            if (itemstack1.getItem().func_46058_c())
            {
                for (int j = 0; j < itemstack1.getItem().getRenderPasses(itemstack1.getItemDamage()); j++)
                {
                    ...
                    GL11.glColor4f(f10, f11, f6, 1.0F);
    ...
    public static int addNewArmourPrefix(String s)
    {
        ArrayList arraylist = new ArrayList(Arrays.asList(armorFilenamePrefix));
        arraylist.add(s);
        armorFilenamePrefix = (String[])arraylist.toArray(new String[0]);
