...
public class RenderItem extends Render
{
    ...
    public void doRenderItem(EntityItem par1EntityItem, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        if (!ForgeHooksClient.renderEntityItem(par1EntityItem, itemstack, f, f1, random, renderManager.renderEngine, renderBlocks))
        {
            if (itemstack.itemID < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[itemstack.itemID].getRenderType()))
            {
                GL11.glRotatef(f1, 0.0F, 1.0F, 0.0F);
                loadTexture(Block.blocksList[itemstack.itemID].getTextureFile());
                float f11 = 0.25F;
                ...
                for (int j1 = 0; j1 < byte0; j1++)
                {
                    ...
                    if (j1 > 0)
                    {
                        float f8 = ((random.nextFloat() * 2.0F - 1.0F) * 0.2F) / f11;
                        float f5 = ((random.nextFloat() * 2.0F - 1.0F) * 0.2F) / f11;
                        float f2 = ((random.nextFloat() * 2.0F - 1.0F) * 0.2F) / f11;
                        GL11.glTranslatef(f8, f5, f2);
                    }

                    float f9 = 1.0F;
                    renderBlocks.renderBlockAsItem(Block.blocksList[itemstack.itemID], itemstack.getItemDamage(), f9);
                    GL11.glPopMatrix();
                }
            }
            else if (itemstack.getItem().func_46058_c())
            {
                ...
                loadTexture(Item.itemsList[itemstack.itemID].getTextureFile());

                for (int l = 0; l < itemstack.getItem().getRenderPasses(itemstack.getItemDamage()); l++)
                {
                    random.setSeed(187L);
                    int j = itemstack.getItem().func_46057_a(itemstack.getItemDamage(), l);
                    float f12 = 1.0F;

                    if (field_27004_a)
                    {
                        int k1 = Item.itemsList[itemstack.itemID].getColorFromDamage(itemstack.getItemDamage(), l);
                        float f6 = (float)(k1 >> 16 & 0xff) / 255F;
                        float f3 = (float)(k1 >> 8 & 0xff) / 255F;
                        float f14 = (float)(k1 & 0xff) / 255F;
                        GL11.glColor4f(f6 * f12, f3 * f12, f14 * f12, 1.0F);
                    }
            ...
            else
            {
                ...
                if (field_27004_a)
                {
                    int k = Item.itemsList[itemstack.itemID].getColorFromDamage(itemstack.getItemDamage(), 0);
                    float f13 = (float)(k >> 16 & 0xff) / 255F;
                    float f10 = (float)(k >> 8 & 0xff) / 255F;
                    float f7 = (float)(k & 0xff) / 255F;
                    float f4 = 1.0F;
                    GL11.glColor4f(f13 * f4, f10 * f4, f7 * f4, 1.0F);
                }

                func_40267_a(i1, byte0);
            }
        }
    ...
    public void drawItemIntoGui(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, int par3, int par4, int par5, int par6, int par7)
    {
        if (par3 < 256 && RenderBlocks.renderItemIn3d(Block.blocksList[par3].getRenderType()))
        {
            ...
            int i = Item.itemsList[par3].getColorFromDamage(par4, 0);
        ...
        else if (Item.itemsList[par3].func_46058_c())
        {
            ...
            for (int k = 0; k < Item.itemsList[par3].getRenderPasses(par4); k++)
            {
                int i1 = Item.itemsList[par3].func_46057_a(par4, k);
                int j = Item.itemsList[par3].getColorFromDamage(par4, k);
                ...
                if (field_27004_a)
                {
                    GL11.glColor4f(f1, f4, f6, 1.0F);
                }

                renderTexturedQuad(par6, par7, (i1 % 16) * 16, (i1 / 16) * 16, 16, 16);
            }
        ...
        else if (par5 >= 0)
        {
            ...
            int l = Item.itemsList[par3].getColorFromDamage(par4, 0);
    ...
    public void renderItemIntoGUI(FontRenderer par1FontRenderer, RenderEngine par2RenderEngine, ItemStack par3ItemStack, int par4, int par5)
    {
        ...
        {
            if (!ForgeHooksClient.renderInventoryItem(renderBlocks, par2RenderEngine, par3ItemStack, field_27004_a, zLevel, par4, par5))
            {
