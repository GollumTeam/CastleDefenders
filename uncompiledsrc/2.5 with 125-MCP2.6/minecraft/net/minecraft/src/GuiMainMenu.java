...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(3, width / 2 - 100, i + 48, 98, 20, stringtranslate.translateKey("menu.mods")));
        controlList.add(new GuiButton(6, width / 2 + 2, i + 48, 98, 20, "Mods"));
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String as[] = FMLCommonHandler.instance().getBrandingStrings("Minecraft 1.2.5");

        for (int j = 0; j < as.length; j++)
        {
            drawString(fontRenderer, as[j], 2, height - (10 + j * (fontRenderer.FONT_HEIGHT + 1)), 0xffffff);
        }
