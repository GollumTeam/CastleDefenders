...
public class BlockRail extends Block
{
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        if (!par1World.isRemote)
        {
            ...
            if (j == 2 && !par1World.isBlockSolidOnSide(par2 + 1, par3, par4, 1))
            {
                flag = true;
            }

            if (j == 3 && !par1World.isBlockSolidOnSide(par2 - 1, par3, par4, 1))
            {
                flag = true;
            }

            if (j == 4 && !par1World.isBlockSolidOnSide(par2, par3, par4 - 1, 1))
            {
                flag = true;
            }

            if (j == 5 && !par1World.isBlockSolidOnSide(par2, par3, par4 + 1, 1))
            {
                flag = true;
            }
    ...
    private boolean isNeighborRailPowered(World par1World, int par2, int par3, int par4, int par5, boolean par6, int par7)
    {
        ...
        return isRailPassingPower(par1World, par2, par3, par4, par6, par7, i) ? true : flag && isRailPassingPower(par1World, par2, par3 - 1, par4, par6, par7, i);
    }
    ...
    public int getBasicRailMetadata(IBlockAccess iblockaccess, EntityMinecart entityminecart, int i, int j, int k)
    {
    ...
    public float getRailMaxSpeed(World world, EntityMinecart entityminecart, int i, int j, int k)
    {
        return 0.4F;
    }

    public void onMinecartPass(World world, EntityMinecart entityminecart, int i, int j, int k)
    {
    }
