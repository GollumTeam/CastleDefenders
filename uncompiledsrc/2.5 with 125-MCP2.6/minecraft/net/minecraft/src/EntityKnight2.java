...
public class EntityKnight2 extends EntityDefender
{
    ...
    public boolean getCanSpawnHere()
    {
        ...
        else
        {
            ...
            List list = worldObj.getEntitiesWithinAABB(net.minecraft.src.EntityKnight2.class, AxisAlignedBB.getBoundingBoxFromPool(posX, posY, posZ, posX + 1.0D, posY + 1.0D, posZ + 1.0D).expand(2D, 2D, 2D));
            return worldObj.getBlockId(i, j - 1, k) == 236 && worldObj.checkIfAABBIsClear(boundingBox) && worldObj.getCollidingBoundingBoxes(this, boundingBox).size() == 0 && list.isEmpty();
        }
    }
