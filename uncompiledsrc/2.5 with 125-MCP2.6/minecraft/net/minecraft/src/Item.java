...
public class Item implements ITextureProvider
{
    ...
    public static Item ghastTear = (new Item(114)).setIconCoord(11, 7).setItemName("ghastTear").setPotionEffect("+0-1-2-3&4-4+13");
    ...
    {
        if (shiftedIndex != potion.shiftedIndex && shiftedIndex != monsterPlacer.shiftedIndex)
        {
    ...
    public int getIconIndex(ItemStack itemstack, int i, EntityPlayer entityplayer, ItemStack itemstack1, int j)
    {
