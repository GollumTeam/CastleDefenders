...
public class BlockRedstoneWire extends Block
{
    ...
    private void calculateCurrentChanges(World par1World, int par2, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        if (i != j)
        {
            ...
            for (int l = 0; l < 4; l++)
            {
                ...
                boolean flag1 = false;
                int j2 = getMaxCurrentStrength(par1World, j1, par3, l1, -1);
    ...
    {
        return wiresProvidePower ? isPoweringTo(par1World, par2, par3, par4, par5) : false;
    }
    ...
    public boolean isPoweringTo(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        return flag2 || flag1 || flag || flag3 || par5 < 2 || par5 > 5 ? par5 != 2 || !flag2 || flag || flag1 ? par5 != 3 || !flag3 || flag || flag1 ? par5 != 4 || !flag || flag2 || flag3 ? par5 == 5 && flag1 && !flag2 && !flag3 : true : true : true : true;
    }
    ...
    public static boolean isPowerProviderOrWire(IBlockAccess par0IBlockAccess, int par1, int par2, int par3, int par4)
    {
        ...
        {
            if (Block.blocksList[i] instanceof IConnectRedstone)
            {
                return ((IConnectRedstone)Block.blocksList[i]).canConnectRedstone(par0IBlockAccess, par1, par2, par3, par4);
            }
            else
            {
