...
public class GuiYesNo extends GuiScreen
{
    ...
    public void initGui()
    {
        this.buttonList.add(new axy(0, this.width / 2 - 155, this.height / 6 + 96, this.buttonText1));
        this.buttonList.add(new axy(1, this.width / 2 - 155 + 160, this.height / 6 + 96, this.buttonText2));
    }
    ...
    {
        this.parentScreen.confirmClicked(var1.f == 0, this.worldNumber);
    }
