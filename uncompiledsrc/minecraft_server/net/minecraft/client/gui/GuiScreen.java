...
{
    public static final boolean isMacOs = Minecraft.c() == avt.d;
    ...
    protected awv fontRenderer;
    public bap guiParticles;

    /** The button that was just pressed. */
    private awg selectedButton = null;
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        {
            awg var5 = (awg)this.buttonList.get(var4);
            var5.a(this.mc, par1, par2);
        }
    }
    ...
    protected void mouseMovedOrUp(int par1, int par2, int par3)
    {
        ...
        {
            this.selectedButton.a(par1, par2);
    ...
    {
        this.guiParticles = new bap(par1Minecraft);
        this.mc = par1Minecraft;
        this.fontRenderer = par1Minecraft.q;
        this.width = par2;
        this.height = par3;
    ...
    {
        int var1 = Mouse.getEventX() * this.width / this.mc.c;
        int var2 = this.height - Mouse.getEventY() * this.height / this.mc.d - 1;

        if (Mouse.getEventButtonState())
        {
            if (this.mc.z.A && this.field_92018_d++ > 0)
            {
                return;
            }

            this.eventButton = Mouse.getEventButton();
            this.field_85043_c = Minecraft.G();
        ...
        {
            long var3 = Minecraft.G() - this.field_85043_c;
    ...
    public void drawBackground(int par1)
    {
        ...
        GL11.glDisable(2912);
        bgd var2 = bgd.a;
        this.mc.p.b("/gui/background.png");
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
        float var3 = 32.0F;
        var2.b();
        var2.d(4210752);
        var2.a(0.0D, (double)this.height, 0.0D, 0.0D, (double)((float)this.height / var3 + (float)par1));
        var2.a((double)this.width, (double)this.height, 0.0D, (double)((float)this.width / var3), (double)((float)this.height / var3 + (float)par1));
        var2.a((double)this.width, 0.0D, 0.0D, (double)((float)this.width / var3), (double)par1);
        var2.a(0.0D, 0.0D, 0.0D, 0.0D, (double)par1);
        var2.a();
    }
