...
public abstract class KeyBindingRegistry$KeyHandler implements ITickHandler
{
    ...
    public KeyBindingRegistry$KeyHandler(ava[] var1, boolean[] var2)
    {
    ...
    public KeyBindingRegistry$KeyHandler(ava[] var1)
    {
        this.keyBindings = var1;
        this.isDummy = true;
    }
    ...
    private void keyTick(EnumSet var1, boolean var2)
    {
        ...
        {
            ava var4 = this.keyBindings[var3];
            int var5 = var4.d;
    ...
    public abstract void keyDown(EnumSet var1, ava var2, boolean var3, boolean var4);

    public abstract void keyUp(EnumSet var1, ava var2, boolean var3);
