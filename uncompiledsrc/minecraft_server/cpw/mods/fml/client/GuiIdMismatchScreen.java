...
public class GuiIdMismatchScreen extends GuiYesNo
{
    ...
    public void drawScreen(int var1, int var2, float var3)
    {
        ...
        {
            awg var9 = (awg)this.buttonList.get(var8);
            var9.d = this.height - 20;

            if (!this.allowContinue)
            {
                var9.c = this.width / 2 - 75;
                var9.e = StringTranslate.getInstance().translateKey("gui.done");
            }

            var9.a(this.mc, var1, var2);
        }
    }
}
