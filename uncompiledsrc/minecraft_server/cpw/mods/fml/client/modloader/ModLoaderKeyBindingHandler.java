...
public class ModLoaderKeyBindingHandler extends KeyBindingRegistry$KeyHandler
{
    ...
    public void fireKeyEvent(ava var1)
    {
        ((BaseMod)this.modContainer.getMod()).keyboardEvent(var1);
    }

    public void keyDown(EnumSet var1, ava var2, boolean var3, boolean var4)
    {
        if (var3)
        {
    ...
    public void keyUp(EnumSet var1, ava var2, boolean var3)
    {
        if (var3)
        {
    ...
    void addKeyBinding(ava var1, boolean var2)
    {
        this.keyBindings = (ava[])ObjectArrays.concat(this.keyBindings, var1);
