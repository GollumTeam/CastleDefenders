...
public class NetClientHandler extends NetHandler
{
    ...
    public NetClientHandler(Minecraft par1Minecraft, String par2Str, int par3) throws UnknownHostException, IOException
    {
        disconnected = false;
        field_1210_g = false;
        mapStorage = new MapStorage((ISaveHandler)null);
    ...
    public void handleVehicleSpawn(Packet23VehicleSpawn par1Packet23VehicleSpawn)
    {
        ...
        try
        {
            obj = ModCompatibilityClient.mlmpVehicleSpawn(par1Packet23VehicleSpawn.type, worldClient, d, d1, d2, getEntityByID(par1Packet23VehicleSpawn.throwerEntityId), obj);
        }
        catch (Exception exception)
        {
            ModLoader.getLogger().throwing("NetClientHandler", "handleVehicleSpawn", exception);
            ModLoader.throwException(String.format("Error initalizing entity of type %d", new Object[]
                    {
                        Integer.valueOf(par1Packet23VehicleSpawn.type)
                    }), exception);
            return;
        }
        ...
        if (obj != null)
        {
            ((Entity)obj).serverPosX = par1Packet23VehicleSpawn.xPosition;
            ((Entity)obj).serverPosY = par1Packet23VehicleSpawn.yPosition;
            ((Entity)obj).serverPosZ = par1Packet23VehicleSpawn.zPosition;
            ...
            ((Entity)obj).entityId = par1Packet23VehicleSpawn.entityId;
    ...
    {
        netManager.networkShutdown("disconnect.kicked", new Object[]
                {
    ...
    public void handleHandshake(Packet2Handshake par1Packet2Handshake)
    {
        ...
        {
            addToSendQueue(ForgeHooksClient.onSendLogin(new Packet1Login(mc.session.username, 29)));
        }
        else
        {
            try
    ...
    {
        return ((Entity)(par1 != mc.thePlayer.entityId ? worldClient.getEntityByID(par1) : mc.thePlayer));
    }
    ...
    {
        Explosion explosion = new Explosion(mc.theWorld, (Entity)null, par1Packet60Explosion.explosionX, par1Packet60Explosion.explosionY, par1Packet60Explosion.explosionZ, par1Packet60Explosion.explosionSize);
    ...
    public void handleTileEntityData(Packet132TileEntityData par1Packet132TileEntityData)
    {
        if (mc.theWorld.blockExists(par1Packet132TileEntityData.xPosition, par1Packet132TileEntityData.yPosition, par1Packet132TileEntityData.zPosition))
        {
            ...
            {
                Packet132TileEntityData packet132tileentitydata = par1Packet132TileEntityData;
                ModLoader.getLogger().log(Level.WARNING, String.format("Received a TileEntityData packet for a location that did not have a TileEntity: (%d, %d, %d) %d: %d, %d, %d", new Object[]
                        {
                            Integer.valueOf(packet132tileentitydata.xPosition), Integer.valueOf(packet132tileentitydata.yPosition), Integer.valueOf(packet132tileentitydata.zPosition), Integer.valueOf(packet132tileentitydata.actionType), Integer.valueOf(packet132tileentitydata.customParam1), Integer.valueOf(packet132tileentitydata.customParam2), Integer.valueOf(packet132tileentitydata.customParam3)
                        }));
            }
        }
    }
    ...
    {
        FMLClientHandler.instance().handlePacket250(packet250custompayload);
        ForgeHooksClient.onCustomPayload(packet250custompayload, netManager);
    }
}
