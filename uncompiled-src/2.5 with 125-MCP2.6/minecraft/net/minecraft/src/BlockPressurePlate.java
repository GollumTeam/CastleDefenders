...
public class BlockPressurePlate extends Block
{
    ...
    private void setStateIfMobInteractsWithPlate(World par1World, int par2, int par3, int par4)
    {
        ...
        {
            list = par1World.getEntitiesWithinAABBExcludingEntity((Entity)null, AxisAlignedBB.getBoundingBoxFromPool((float)par2 + f, par3, (float)par4 + f, (float)(par2 + 1) - f, (double)par3 + 0.25D, (float)(par4 + 1) - f));
        }
    ...
    {
        return par1World.getBlockMetadata(par2, par3, par4) != 0 ? par5 == 1 : false;
    }
