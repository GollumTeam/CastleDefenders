...
public class BlockFire extends Block
{
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        boolean flag = block != null && block.isFireSource(par1World, par2, par3 - 1, par4, par1World.getBlockMetadata(par2, par3 - 1, par4), 0);
        ...
        else
        {
            ...
            {
                if (!par1World.isBlockSolidOnSide(par2, par3 - 1, par4, 1) || i > 3)
                {
                    par1World.setBlockWithNotify(par2, par3, par4, 0);
                }
            }
            else if (!flag && !canBlockCatchFire(par1World, par2, par3 - 1, par4, 1) && i == 15 && par5Random.nextInt(4) == 0)
            {
                par1World.setBlockWithNotify(par2, par3, par4, 0);
            }
            else
            {
                ...
                tryToCatchBlockOnFire(par1World, par2 + 1, par3, par4, 300 + byte0, par5Random, i, 4);
                tryToCatchBlockOnFire(par1World, par2 - 1, par3, par4, 300 + byte0, par5Random, i, 5);
                tryToCatchBlockOnFire(par1World, par2, par3 - 1, par4, 250 + byte0, par5Random, i, 1);
                tryToCatchBlockOnFire(par1World, par2, par3 + 1, par4, 250 + byte0, par5Random, i, 0);
                tryToCatchBlockOnFire(par1World, par2, par3, par4 - 1, 300 + byte0, par5Random, i, 3);
                tryToCatchBlockOnFire(par1World, par2, par3, par4 + 1, 300 + byte0, par5Random, i, 2);
    ...
    private void tryToCatchBlockOnFire(World world, int i, int j, int k, int l, Random random, int i1, int j1)
    {
        int k1 = 0;
    ...
    private int getChanceOfNeighborsEncouragingFire(World par1World, int par2, int par3, int par4)
    {
        ...
        {
            int j = getChanceToEncourageFire(par1World, par2 + 1, par3, par4, i, 4);
            j = getChanceToEncourageFire(par1World, par2 - 1, par3, par4, j, 5);
            j = getChanceToEncourageFire(par1World, par2, par3 - 1, par4, j, 1);
            j = getChanceToEncourageFire(par1World, par2, par3 + 1, par4, j, 0);
            j = getChanceToEncourageFire(par1World, par2, par3, par4 - 1, j, 3);
            j = getChanceToEncourageFire(par1World, par2, par3, par4 + 1, j, 2);
            return j;
        }
    }
    ...
    {
        return par1World.isBlockSolidOnSide(par2, par3 - 1, par4, 1) || canNeighborBurn(par1World, par2, par3, par4);
    }
    ...
    {
        if (!par1World.isBlockSolidOnSide(par2, par3 - 1, par4, 1) && !canNeighborBurn(par1World, par2, par3, par4))
        {
            par1World.setBlockWithNotify(par2, par3, par4, 0);
        }
    }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (!par1World.isBlockSolidOnSide(par2, par3 - 1, par4, 1) && !Block.fire.canBlockCatchFire(par1World, par2, par3 - 1, par4, 1))
        {
            if (Block.fire.canBlockCatchFire(par1World, par2 - 1, par3, par4, 5))
            {
                for (int i = 0; i < 2; i++)
                {
                    float f = (float)par2 + par5Random.nextFloat() * 0.1F;
                    float f6 = (float)par3 + par5Random.nextFloat();
            ...
            if (Block.fire.canBlockCatchFire(par1World, par2 + 1, par3, par4, 4))
            {
                for (int j = 0; j < 2; j++)
                {
                    float f1 = (float)(par2 + 1) - par5Random.nextFloat() * 0.1F;
            ...
            if (Block.fire.canBlockCatchFire(par1World, par2, par3, par4 - 1, 3))
            {
                for (int k = 0; k < 2; k++)
                {
                    float f2 = (float)par2 + par5Random.nextFloat();
                    float f8 = (float)par3 + par5Random.nextFloat();
                    float f14 = (float)par4 + par5Random.nextFloat() * 0.1F;
            ...
            if (Block.fire.canBlockCatchFire(par1World, par2, par3, par4 + 1, 2))
            {
                for (int l = 0; l < 2; l++)
                {
                    ...
                    float f15 = (float)(par4 + 1) - par5Random.nextFloat() * 0.1F;
            ...
            if (Block.fire.canBlockCatchFire(par1World, par2, par3 + 1, par4, 0))
            {
                for (int i1 = 0; i1 < 2; i1++)
                {
                    ...
                    float f10 = (float)(par3 + 1) - par5Random.nextFloat() * 0.1F;
                    float f16 = (float)par4 + par5Random.nextFloat();
        ...
        else
        {
            for (int j1 = 0; j1 < 3; j1++)
            {
                ...
                float f11 = (float)par3 + par5Random.nextFloat() * 0.5F + 0.5F;
