...
public abstract class EntityLiving extends Entity
{
    ...
    {
        return maximumHomeDistance != -1F ? homePosition.getDistanceSquared(par1, par2, par3) < maximumHomeDistance * maximumHomeDistance : true;
    }
    ...
    public void onUpdate()
    {
        ...
        field_9361_v += (f3 - field_9361_v) * 0.3F;
    ...
    public void moveEntityWithHeading(float par1, float par2)
    {
        ...
        float f3 = MathHelper.sqrt_double(d2 * d2 + d3 * d3) * 4F;
        ...
        field_704_R += (f3 - field_704_R) * 0.4F;
    ...
    public boolean isOnLadder()
    {
        ...
        return Block.blocksList[l] != null && Block.blocksList[l].isLadder(worldObj, i, j, k);
    }
