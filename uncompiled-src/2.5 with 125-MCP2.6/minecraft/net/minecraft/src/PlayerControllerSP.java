...
public class PlayerControllerSP extends PlayerController
{
    ...
    public boolean onPlayerDestroyBlock(int par1, int par2, int par3, int par4)
    {
        ...
        if (itemstack != null && itemstack.getItem().onBlockStartBreak(itemstack, par1, par2, par3, mc.thePlayer))
        {
            return false;
        }
        ...
        boolean flag1 = Block.blocksList[i].canHarvestBlock(mc.thePlayer, j);

        if (itemstack1 != null)
        {
            itemstack1.onDestroyBlock(i, par1, par2, par3, mc.thePlayer);

            if (itemstack1.stackSize == 0)
            {
                itemstack1.onItemDestroyedByUse(mc.thePlayer);
    ...
    public void clickBlock(int par1, int par2, int par3, int par4)
    {
        if (mc.thePlayer.canPlayerEdit(par1, par2, par3))
        {
            ...
            if (i > 0 && Block.blocksList[i].blockStrength(mc.theWorld, mc.thePlayer, par1, par2, par3) >= 1.0F)
            {
    ...
    public void onPlayerDamageBlock(int par1, int par2, int par3, int par4)
    {
        ...
        else if (par1 == curBlockX && par2 == curBlockY && par3 == curBlockZ)
        {
            int i = mc.theWorld.getBlockId(par1, par2, par3);
            ...
            curBlockDamage += block.blockStrength(mc.theWorld, mc.thePlayer, par1, par2, par3);
    ...
    {
        if (par3ItemStack != null && par3ItemStack.getItem() != null && par3ItemStack.getItem().onItemUseFirst(par3ItemStack, par1EntityPlayer, par2World, par4, par5, par6, par7))
        {
            return true;
        }
