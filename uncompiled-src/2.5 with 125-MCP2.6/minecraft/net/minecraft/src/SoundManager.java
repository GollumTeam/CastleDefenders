...
import forge.ModCompatibilityClient;
import java.io.File;
...
public class SoundManager
{
    ...
    public SoundManager()
    {
        ...
        latestSoundID = 0;
        rand = new Random();
        ticksBeforeMusic = rand.nextInt(MUSIC_INTERVAL);
    }
    ...
    {
        if (loaded && options.musicVolume != 0.0F && !sndSystem.playing("BgMusic") && !sndSystem.playing("streaming"))
        {
            ...
            soundpoolentry = ForgeHooksClient.onPlayBackgroundMusic(this, soundpoolentry);

            if (soundpoolentry != null)
            {
                ticksBeforeMusic = rand.nextInt(MUSIC_INTERVAL) + MUSIC_INTERVAL;
    ...
    public void playStreaming(String par1Str, float par2, float par3, float par4, float par5, float par6)
    {
        if (loaded && (options.soundVolume != 0.0F || par1Str == null))
        {
            ...
            if (par1Str != null)
            {
                ...
                soundpoolentry = ForgeHooksClient.onPlayStreaming(this, soundpoolentry, par1Str, par2, par3, par4);
    ...
    public void playSound(String par1Str, float par2, float par3, float par4, float par5, float par6)
    {
        if (loaded && options.soundVolume != 0.0F)
        {
            ...
            soundpoolentry = ForgeHooksClient.onPlaySound(this, soundpoolentry, par1Str, par2, par3, par4, par5, par6);
    ...
    public void playSoundFX(String par1Str, float par2, float par3)
    {
        ...
        {
            SoundPoolEntry soundpoolentry = soundPoolSounds.getRandomSoundFromSoundPool(par1Str);
            soundpoolentry = ForgeHooksClient.onPlaySoundEffect(this, soundpoolentry, par1Str, par2, par3);
