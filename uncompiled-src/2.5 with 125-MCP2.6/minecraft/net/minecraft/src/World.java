...
{
    public static double MAX_ENTITY_RADIUS = 2D;
    ...
    {
        return par1 < 0xfe363c80 || par3 < 0xfe363c80 || par1 >= 0x1c9c380 || par3 >= 0x1c9c380 ? 0 : par2 >= 0 ? par2 < 256 ? getChunkFromChunkCoords(par1 >> 4, par3 >> 4).getBlockID(par1 & 0xf, par2, par3 & 0xf) : 0 : 0;
    }

    public int func_48462_d(int par1, int par2, int par3)
    {
        return par1 < 0xfe363c80 || par3 < 0xfe363c80 || par1 >= 0x1c9c380 || par3 >= 0x1c9c380 ? 0 : par2 >= 0 ? par2 < 256 ? getChunkFromChunkCoords(par1 >> 4, par3 >> 4).getBlockLightOpacity(par1 & 0xf, par2, par3 & 0xf) : 0 : 0;
    }
    ...
    public boolean isAirBlock(int par1, int par2, int par3)
    {
        ...
        return i == 0 || Block.blocksList[i] == null || Block.blocksList[i].isAirBlock(this, par1, par2, par3);
    }
    ...
    {
        return par2 < 0 || par2 >= 256 ? false : chunkExists(par1 >> 4, par3 >> 4);
    }
    ...
    {
        int i = getBlockId(par1, par2, par3);
        return i != 0 ? Block.blocksList[i].blockMaterial : Material.air;
    }
    ...
    {
        if (par2 >= 0xfe363c80 && par4 >= 0xfe363c80 && par2 < 0x1c9c380 && par4 < 0x1c9c380 && par3 >= 0 && par3 < 256 && chunkExists(par2 >> 4, par4 >> 4))
        {
    ...
    public void scheduleBlockUpdate(int par1, int par2, int par3, int par4, int par5)
    {
        ...
        else if (checkChunksExist(par1 - byte0, par2 - byte0, par3 - byte0, par1 + byte0, par2 + byte0, par3 + byte0))
        {
            if (par4 > 0)
            {
    ...
    public void updateEntities()
    {
        ...
        if (!entityRemoval.isEmpty())
        {
            ...
            for (Iterator iterator1 = entityRemoval.iterator(); iterator1.hasNext(); ((TileEntity)obj).onChunkUnload())
            {
                obj = iterator1.next();
            }
        ...
        {
            Iterator iterator2 = addedTileEntityList.iterator();
            ...
            do
            {
                ...
                TileEntity tileentity1 = (TileEntity)iterator2.next();
                ...
                else if (chunkExists(tileentity1.xCoord >> 4, tileentity1.zCoord >> 4))
                {
    ...
    {
        List list = scanningTileEntities ? addedTileEntityList : loadedTileEntityList;
    ...
    public void updateEntityWithOptionalForce(Entity par1Entity, boolean par2)
    {
        ...
        if (!par2 || checkChunksExist(i - byte0, 0, j - byte0, i + byte0, 0, j + byte0) || ForgeHooks.canUpdateEntity(par1Entity))
        {
    ...
    {
        List list = getEntitiesWithinAABBExcludingEntity((Entity)null, par1AxisAlignedBB);
    ...
    {
        Block block = Block.blocksList[getBlockId(par1, par2, par3)];
        return block != null ? block.isOpaqueCube() : false;
    }
    ...
    public boolean isBlockNormalCubeDefault(int par1, int par2, int par3, boolean par4)
    {
        if (par1 >= 0xfe363c80 && par3 >= 0xfe363c80 && par1 < 0x1c9c380 && par3 < 0x1c9c380)
        {
            ...
            {
                Block block = Block.blocksList[getBlockId(par1, par2, par3)];
                return block != null ? isBlockNormalCube(par1, par2, par3) : false;
            }
            else
            {
                return par4;
    ...
    {
        int i = par5 != 0 && Block.blocksList[par5] != null ? Block.blocksList[par5].getLightValue(this, par2, par3, par4) : 0;
    ...
    public void updateLightByType(EnumSkyBlock par1EnumSkyBlock, int par2, int par3, int par4)
    {
        if (doChunksNearChunkExist(par2, par3, par4, 17))
        {
            ...
            int l1 = func_48462_d(par2, par3, par4);
            ...
            else if (k2 < k)
            {
                ...
                do
                {
                    ...
                    int j3 = lightUpdateBlockList[i++];
                    int j1 = ((j3 & 0x3f) - 32) + par2;
                    int i2 = ((j3 >> 6 & 0x3f) - 32) + par3;
                    int l2 = ((j3 >> 12 & 0x3f) - 32) + par4;
                    int l3 = j3 >> 18 & 0xf;
                    int j4 = getSavedLightValue(par1EnumSkyBlock, j1, i2, l2);

                    if (j4 == l3)
                    {
                        setLightValue(par1EnumSkyBlock, j1, i2, l2, 0);
                        ...
                        if (l3 > 0)
                        {
                            ...
                            if (i5 + i6 + k5 < 17)
                            {
                                ...
                                {
                                    int i7 = (k6 % 2) * 2 - 1;
                                    int j7 = j1 + (((k6 / 2) % 3) / 2) * i7;
                                    int k7 = i2 + (((k6 / 2 + 1) % 3) / 2) * i7;
                                    int l7 = l2 + (((k6 / 2 + 2) % 3) / 2) * i7;
                                    int k4 = getSavedLightValue(par1EnumSkyBlock, j7, k7, l7);
                                    int i8 = Block.lightOpacity[getBlockId(j7, k7, l7)];
                                    ...
                                    if (k4 == l3 - i8 && j < lightUpdateBlockList.length)
                                    {
                                        lightUpdateBlockList[j++] = (j7 - par2) + 32 + ((k7 - par3) + 32 << 6) + ((l7 - par4) + 32 << 12) + (l3 - i8 << 18);
                                    }
            ...
            do
            {
                ...
                int l6 = ((l & 0x3f) - 32) + par2;
                int k3 = ((l >> 6 & 0x3f) - 32) + par3;
                int k1 = ((l >> 12 & 0x3f) - 32) + par4;
                int j2 = getSavedLightValue(par1EnumSkyBlock, l6, k3, k1);
                int i3 = getBlockId(l6, k3, k1);
                int i4 = Block.lightOpacity[i3];
                ...
                if (par1EnumSkyBlock == EnumSkyBlock.Sky)
                {
                    l4 = computeSkyLightValue(j2, l6, k3, k1, i3, i4);
                }
                else
                {
                    l4 = computeBlockLightValue(j2, l6, k3, k1, i3, i4);
                }

                if (l4 != j2)
                {
                    setLightValue(par1EnumSkyBlock, l6, k3, k1, l4);
                    ...
                    if (l4 > j2)
                    {
                        ...
                        if (j5 + j6 + l5 < 17 && j < lightUpdateBlockList.length - 6)
                        {
                            if (getSavedLightValue(par1EnumSkyBlock, l6 - 1, k3, k1) < l4)
                            {
                                lightUpdateBlockList[j++] = (l6 - 1 - par2) + 32 + ((k3 - par3) + 32 << 6) + ((k1 - par4) + 32 << 12);
                            }
                            ...
                            if (getSavedLightValue(par1EnumSkyBlock, l6, k3 - 1, k1) < l4)
                            {
                                lightUpdateBlockList[j++] = (l6 - par2) + 32 + ((k3 - 1 - par3) + 32 << 6) + ((k1 - par4) + 32 << 12);
                            }
                            ...
                            if (getSavedLightValue(par1EnumSkyBlock, l6, k3, k1 - 1) < l4)
                            {
                                lightUpdateBlockList[j++] = (l6 - par2) + 32 + ((k3 - par3) + 32 << 6) + ((k1 - 1 - par4) + 32 << 12);
                            }
    ...
    public List getEntitiesWithinAABBExcludingEntity(Entity par1Entity, AxisAlignedBB par2AxisAlignedBB)
    {
        ...
        int i = MathHelper.floor_double((par2AxisAlignedBB.minX - MAX_ENTITY_RADIUS) / 16D);
        int j = MathHelper.floor_double((par2AxisAlignedBB.maxX + MAX_ENTITY_RADIUS) / 16D);
        int k = MathHelper.floor_double((par2AxisAlignedBB.minZ - MAX_ENTITY_RADIUS) / 16D);
        int l = MathHelper.floor_double((par2AxisAlignedBB.maxZ + MAX_ENTITY_RADIUS) / 16D);
    ...
    {
        int i = getBlockId(par1, par2, par3);
        return i != 0 ? Block.blocksList[i].isIndirectlyPoweringTo(this, par1, par2, par3, par4) : false;
    }
    ...
    {
        return isBlockProvidingPowerTo(par1, par2 - 1, par3, 0) ? true : isBlockProvidingPowerTo(par1, par2 + 1, par3, 1) ? true : isBlockProvidingPowerTo(par1, par2, par3 - 1, 2) ? true : isBlockProvidingPowerTo(par1, par2, par3 + 1, 3) ? true : isBlockProvidingPowerTo(par1 - 1, par2, par3, 4) ? true : isBlockProvidingPowerTo(par1 + 1, par2, par3, 5);
    }
    ...
    public boolean isBlockIndirectlyProvidingPowerTo(int par1, int par2, int par3, int par4)
    {
        ...
        {
            int i = getBlockId(par1, par2, par3);
            return i != 0 ? Block.blocksList[i].isPoweringTo(this, par1, par2, par3, par4) : false;
        }
    }
    ...
    {
        return isBlockIndirectlyProvidingPowerTo(par1, par2 - 1, par3, 0) ? true : isBlockIndirectlyProvidingPowerTo(par1, par2 + 1, par3, 1) ? true : isBlockIndirectlyProvidingPowerTo(par1, par2, par3 - 1, 2) ? true : isBlockIndirectlyProvidingPowerTo(par1, par2, par3 + 1, 3) ? true : isBlockIndirectlyProvidingPowerTo(par1 - 1, par2, par3, 4) ? true : isBlockIndirectlyProvidingPowerTo(par1 + 1, par2, par3, 5);
    }
    ...
    public SpawnListEntry getRandomMob(EnumCreatureType par1EnumCreatureType, int par2, int par3, int par4)
    {
        ...
        return list == null || list.isEmpty() ? null : (SpawnListEntry)WeightedRandom.getRandomItem(rand, list);
    }
    ...
    public boolean isBlockSolidOnSide(int i, int j, int k, int l)
    {
        ...
        {
            return block.isBlockSolidOnSide(this, i, j, k, l);
        }
    }
}
