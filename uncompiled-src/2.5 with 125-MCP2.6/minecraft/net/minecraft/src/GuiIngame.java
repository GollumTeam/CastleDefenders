...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float par1, boolean par2, int par3, int par4)
    {
        ...
        if (!mc.playerController.func_35643_e())
        {
            ...
            int k = mc.thePlayer.getHealth();
            int k1 = mc.thePlayer.prevHealth;
            rand.setSeed(updateCounter * 0x4c627);
            boolean flag2 = false;
            FoodStats foodstats = mc.thePlayer.getFoodStats();
            int l2 = foodstats.getFoodLevel();
            int j2 = foodstats.getPrevFoodLevel();
            renderBossHealth();
            ...
            if (mc.playerController.shouldDrawHUD())
            {
                int j8 = i / 2 - 91;
                int j3 = i / 2 + 91;
                int i4 = mc.thePlayer.xpBarCap();

                if (i4 > 0)
                {
                    char c = '\266';
                    int k5 = (int)(mc.thePlayer.experience * (float)(c + 1));
                    int l4 = (j - 32) + 3;
                    drawTexturedModalRect(j8, l4, 0, 64, c, 5);

                    if (k5 > 0)
                    {
                        drawTexturedModalRect(j8, l4, 0, 69, k5, 5);
                    }
                }
                ...
                for (int i9 = 0; i9 < mc.thePlayer.inventory.armorInventory.length; i9++)
                {
                    ItemStack itemstack1 = mc.thePlayer.inventory.armorInventory[i9];

                    if (itemstack1 != null && (itemstack1.getItem() instanceof ISpecialArmor))
                    {
                        i5 += ((ISpecialArmor)itemstack1.getItem()).getArmorDisplay(mc.thePlayer, itemstack1, i9);
                        continue;
                    }

                    if (itemstack1 != null && (itemstack1.getItem() instanceof ItemArmor))
                    {
                        i5 += ((ItemArmor)itemstack1.getItem()).damageReduceAmount;
                    }
                }
                ...
                for (int k9 = 0; k9 < 10; k9++)
                {
                    if (i5 > 0)
                    {
                        ...
                        if (k9 * 2 + 1 < i5)
                        {
                            drawTexturedModalRect(j10, l5, 34, 9, 9, 9);
                        }

                        if (k9 * 2 + 1 == i5)
                        {
                            drawTexturedModalRect(j10, l5, 25, 9, 9, 9);
                        }

                        if (k9 * 2 + 1 > i5)
                        {
                            drawTexturedModalRect(j10, l5, 16, 9, 9, 9);
                        }
                    }
                    ...
                    drawTexturedModalRect(j12, k11, 16 + i13 * 9, 9 * byte2, 9, 9);

                    if (flag)
                    {
                        if (k9 * 2 + 1 < k1)
                        {
                            drawTexturedModalRect(j12, k11, k10 + 54, 9 * byte2, 9, 9);
                        }

                        if (k9 * 2 + 1 == k1)
                        {
                            drawTexturedModalRect(j12, k11, k10 + 63, 9 * byte2, 9, 9);
                        }
                    }

                    if (k9 * 2 + 1 < k)
                    {
                        drawTexturedModalRect(j12, k11, k10 + 36, 9 * byte2, 9, 9);
                    }

                    if (k9 * 2 + 1 == k)
                    {
                        drawTexturedModalRect(j12, k11, k10 + 45, 9 * byte2, 9, 9);
                    }
                }
                ...
                for (int l9 = 0; l9 < 10; l9++)
                {
                    ...
                    if (mc.thePlayer.getFoodStats().getSaturationLevel() <= 0.0F && updateCounter % (l2 * 3 + 1) == 0)
                    {
                        i11 = j6 + (rand.nextInt(3) - 1);
                    }
                    ...
                    int l11 = j3 - l9 * 8 - 9;
                    drawTexturedModalRect(l11, i11, 16 + byte3 * 9, 27, 9, 9);

                    if (flag2)
                    {
                        if (l9 * 2 + 1 < j2)
                        {
                            drawTexturedModalRect(l11, i11, j13 + 54, 27, 9, 9);
                        }

                        if (l9 * 2 + 1 == j2)
                        {
                            drawTexturedModalRect(l11, i11, j13 + 63, 27, 9, 9);
                        }
                    }

                    if (l9 * 2 + 1 < l2)
                    {
                        drawTexturedModalRect(l11, i11, j13 + 36, 27, 9, 9);
                    }

                    if (l9 * 2 + 1 == l2)
                    {
                        drawTexturedModalRect(l11, i11, j13 + 45, 27, 9, 9);
                    }
                }

                if (mc.thePlayer.isInsideOfMaterial(Material.water))
                {
                    int i10 = mc.thePlayer.getAir();
                    int j11 = (int)Math.ceil(((double)(i10 - 2) * 10D) / 300D);
                    int k13 = (int)Math.ceil(((double)i10 * 10D) / 300D) - j11;

                    for (int k12 = 0; k12 < j11 + k13; k12++)
                    {
                        if (k12 < j11)
                        {
                            drawTexturedModalRect(j3 - k12 * 8 - 9, l5, 16, 18, 9, 9);
                        }
                        else
                        {
                            drawTexturedModalRect(j3 - k12 * 8 - 9, l5, 25, 18, 9, 9);
                        }
                    }
                }
            }
            ...
            {
                int k3 = (i / 2 - 90) + k8 * 20 + 2;
                int j4 = j - 16 - 3;
                renderInventorySlot(k8, k3, j4, par1);
            }
        ...
        if (mc.thePlayer.getSleepTimer() > 0)
        {
            ...
            int i7 = mc.thePlayer.getSleepTimer();
            float f1 = (float)i7 / 100F;

            if (f1 > 1.0F)
            {
                f1 = 1.0F - (float)(i7 - 100) / 10F;
            }

            int l = (int)(220F * f1) << 24 | 0x101020;
            drawRect(0, 0, i, j, l);
        ...
        {
            boolean flag1 = false;
            int i1 = flag1 ? 0xffffff : 0x80ff20;
            String s = (new StringBuilder()).append("").append(mc.thePlayer.experienceLevel).toString();
            int l7 = (i - fontrenderer.getStringWidth(s)) / 2;
            int j7 = j - 31 - 4;
            fontrenderer.drawString(s, l7 + 1, j7, 0);
            fontrenderer.drawString(s, l7 - 1, j7, 0);
            fontrenderer.drawString(s, l7, j7 + 1, 0);
            fontrenderer.drawString(s, l7, j7 - 1, 0);
            fontrenderer.drawString(s, l7, j7, i1);
        }
        ...
        if (mc.gameSettings.showDebugInfo)
        {
            ...
            long l8 = Runtime.getRuntime().maxMemory();
            long l10 = Runtime.getRuntime().totalMemory();
            long l12 = Runtime.getRuntime().freeMemory();
            long l13 = l10 - l12;
            String s1 = (new StringBuilder()).append("Used memory: ").append((l13 * 100L) / l8).append("% (").append(l13 / 1024L / 1024L).append("MB) of ").append(l8 / 1024L / 1024L).append("MB").toString();
            drawString(fontrenderer, s1, i - fontrenderer.getStringWidth(s1) - 2, 2, 0xe0e0e0);
            s1 = (new StringBuilder()).append("Allocated memory: ").append((l10 * 100L) / l8).append("% (").append(l10 / 1024L / 1024L).append("MB)").toString();
            ...
            int k6 = MathHelper.floor_double(mc.thePlayer.posX);
            int i6 = MathHelper.floor_double(mc.thePlayer.posY);
            int j5 = MathHelper.floor_double(mc.thePlayer.posZ);

            if (mc.theWorld != null && mc.theWorld.blockExists(k6, i6, j5))
            {
                Chunk chunk = mc.theWorld.getChunkFromBlockCoords(k6, j5);
                drawString(fontrenderer, (new StringBuilder()).append("lc: ").append(chunk.getTopFilledSegment() + 15).append(" b: ").append(chunk.func_48490_a(k6 & 0xf, j5 & 0xf, mc.theWorld.getWorldChunkManager()).biomeName).append(" bl: ").append(chunk.getSavedLightValue(EnumSkyBlock.Block, k6 & 0xf, i6, j5 & 0xf)).append(" sl: ").append(chunk.getSavedLightValue(EnumSkyBlock.Sky, k6 & 0xf, i6, j5 & 0xf)).append(" rl: ").append(chunk.getBlockLightValue(k6 & 0xf, i6, j5 & 0xf, 0)).toString(), 2, 96, 0xe0e0e0);
            }
        ...
        if (recordPlayingUpFor > 0)
        {
            ...
            if (j1 > 0)
            {
                ...
                if (recordIsPlaying)
                {
                    l1 = Color.HSBtoRGB(f2 / 50F, 0.7F, 0.6F) & 0xffffff;
                }

                fontrenderer.drawString(recordPlaying, -fontrenderer.getStringWidth(recordPlaying) / 2, -4, l1 + (j1 << 24));
                GL11.glDisable(GL11.GL_BLEND);
                GL11.glPopMatrix();
            }
        }
        ...
        if ((mc.thePlayer instanceof EntityClientPlayerMP) && mc.gameSettings.keyBindPlayerList.pressed)
        {
            ...
            int i2 = netclienthandler.currentServerMaxPlayers;
            int i8 = i2;
            int k7 = 1;

            for (; i8 > 20; i8 = ((i2 + k7) - 1) / k7)
            {
                k7++;
            }
            ...
            int k2 = (i - k7 * i3) / 2;
            byte byte0 = 10;
            drawRect(k2 - 1, byte0 - 1, k2 + i3 * k7, byte0 + 9 * i8, 0x80000000);

            for (int l3 = 0; l3 < i2; l3++)
            {
                int k4 = k2 + (l3 % k7) * i3;
                int l6 = byte0 + (l3 / k7) * 9;
                drawRect(k4, l6, (k4 + i3) - 1, l6 + 8, 0x20ffffff);
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                GL11.glEnable(GL11.GL_ALPHA_TEST);
                ...
                GuiPlayerInfo guiplayerinfo = (GuiPlayerInfo)list.get(l3);
                fontrenderer.drawStringWithShadow(guiplayerinfo.name, k4, l6, 0xffffff);
                ...
                zLevel += 100F;
                drawTexturedModalRect((k4 + i3) - 12, l6, 0 + i12 * 10, 176 + byte1 * 8, 10, 8);
                zLevel -= 100F;
            }
        }
        ...
        if (j > 0)
        {
            ...
            for (int k = 0; k + field_50017_n < chatMessageList.size() && k < byte0; k++)
            {
                ...
                if (i1 > 2)
                {
                    ...
                    drawRect(byte1, j2 - 1, byte1 + 320 + 4, j2 + 8, i1 / 2 << 24);
                    GL11.glEnable(GL11.GL_BLEND);
                    par1FontRenderer.drawStringWithShadow(s, byte1, j2, 0xffffff + (i1 << 24));
                }
            }
            ...
            if (flag)
            {
                ...
                int j1 = i * par1FontRenderer.FONT_HEIGHT + i;
                int k1 = (field_50017_n * j1) / j;
                int l1 = (j1 * j1) / l;
                ...
                if (l != j1)
                {
                    ...
                    drawRect(0, -k1, 2, -k1 - l1, i2 + (c << 24));
                    drawRect(2, -k1, 1, -k1 - l1, 0xcccccc + (c << 24));
                }
            }
        }
    }
