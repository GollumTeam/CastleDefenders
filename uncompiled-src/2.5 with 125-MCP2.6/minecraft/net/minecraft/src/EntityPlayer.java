...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (isSprinting())
        {
            landMovementFactor = (float)((double)landMovementFactor + (double)speedOnGround * 0.29999999999999999D);
            jumpMovementFactor = (float)((double)jumpMovementFactor + (double)speedInAir * 0.29999999999999999D);
        }
    ...
    protected int decreaseAirSupply(int par1)
    {
        ...
        return i <= 0 || rand.nextInt(i + 1) <= 0 ? super.decreaseAirSupply(par1) : par1;
    }
    ...
    public EntityItem dropOneItem()
    {
        ...
        if (itemstack.getItem().onDroppedByPlayer(itemstack, this))
        {
    ...
    {
        ItemStack itemstack = inventory.getCurrentItem();
        float f = itemstack != null ? itemstack.getItem().getStrVsBlock(itemstack, block, i) : 1.0F;
        float f1 = f;
        int j = EnchantmentHelper.getEfficiencyModifier(inventory);

        if (j > 0 && ForgeHooks.canHarvestBlock(block, this, i))
        {
            f1 = f + (float)(j * j + 1);
        }
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        {
            entity1 = ((EntityArrow)entity).shootingEntity;
        }
    ...
    public void destroyCurrentEquippedItem()
    {
        ...
        ForgeHooks.onDestroyCurrentItem(this, itemstack);
    }
    ...
    public void attackTargetEntityWithCurrentItem(Entity par1Entity)
    {
        ...
        if (itemstack != null && itemstack.getItem().onLeftClickEntity(itemstack, this, par1Entity))
        {
            return;
        }
        ...
        if (par1Entity.canAttackWithItem())
        {
            ...
            if (i > 0 || k > 0)
            {
                ...
                ItemStack itemstack1 = getCurrentEquippedItem();

                if (itemstack1 != null && (par1Entity instanceof EntityLiving))
                {
                    itemstack1.hitEntity((EntityLiving)par1Entity, this);

                    if (itemstack1.stackSize <= 0)
                    {
                        itemstack1.onItemDestroyedByUse(this);
                        destroyCurrentEquippedItem();
                    }
                }
    ...
    {
        EnumStatus enumstatus = ForgeHooks.sleepInBedAt(this, par1, par2, par3);
        ...
        if (worldObj.blockExists(par1, par2, par3))
        {
            ...
            if (block != null)
            {
                j = block.getBedDirection(worldObj, par1, par2, par3);
            }
    ...
    public void wakeUpPlayer(boolean par1, boolean par2, boolean par3)
    {
        ...
        Block block = chunkcoordinates != null ? Block.blocksList[worldObj.getBlockId(chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ)] : null;
        ...
        {
            block.setBedOccupied(worldObj, chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ, this, false);
            ChunkCoordinates chunkcoordinates2 = block.getBedSpawnPosition(worldObj, chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ, this);
    ...
    {
        ChunkCoordinates chunkcoordinates = playerLocation;
        int i = worldObj.getBlockId(chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ);
        return Block.blocksList[i] != null && Block.blocksList[i].isBed(worldObj, chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ, this);
    }
    ...
    public static ChunkCoordinates verifyRespawnCoordinates(World par0World, ChunkCoordinates par1ChunkCoordinates)
    {
        ...
        Block block = Block.blocksList[par0World.getBlockId(chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ)];

        if (block == null || !block.isBed(par0World, chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ, null))
        {
            return null;
        }
        else
        {
            ChunkCoordinates chunkcoordinates1 = block.getBedSpawnPosition(par0World, chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ, null);
    ...
    public float getBedOrientationInDegrees()
    {
        ...
        {
            int i = playerLocation.posX;
            int j = playerLocation.posY;
            int k = playerLocation.posZ;
            Block block = Block.blocksList[worldObj.getBlockId(i, j, k)];
            int l = block != null ? block.getBedDirection(worldObj, i, j, k) : 0;
    ...
    public int getItemIcon(ItemStack par1ItemStack, int par2)
    {
        ...
        else
        {
            ...
            i = par1ItemStack.getItem().getIconIndex(par1ItemStack, par2, this, itemInUse, itemInUseCount);
        }
    ...
    {
        if (!capabilities.disableDamage && !worldObj.isRemote)
        {
    ...
    public void openGui(BaseMod basemod, int i, World world, int j, int k, int l)
    {
        if (this instanceof EntityPlayerSP)
        {
            IGuiHandler iguihandler = MinecraftForge.getGuiHandler(basemod);

            if (iguihandler != null)
            {
                GuiScreen guiscreen = (GuiScreen)iguihandler.getGuiElement(i, this, world, j, k, l);

                if (guiscreen != null)
                {
                    ModLoader.getMinecraftInstance().displayGuiScreen(guiscreen);
                }
            }
        }
    }
