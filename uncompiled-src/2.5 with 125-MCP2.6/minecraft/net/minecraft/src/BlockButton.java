...
public class BlockButton extends Block
{
    ...
    {
        return par5 == 2 && par1World.isBlockSolidOnSide(par2, par3, par4 + 1, 2) || par5 == 3 && par1World.isBlockSolidOnSide(par2, par3, par4 - 1, 3) || par5 == 4 && par1World.isBlockSolidOnSide(par2 + 1, par3, par4, 4) || par5 == 5 && par1World.isBlockSolidOnSide(par2 - 1, par3, par4, 5);
    }
    ...
    private int getOrientation(World par1World, int par2, int par3, int par4)
    {
        ...
        if (par1World.isBlockSolidOnSide(par2 + 1, par3, par4, 4))
        {
            return 2;
        }
        ...
        return !par1World.isBlockSolidOnSide(par2, par3, par4 + 1, 2) ? 1 : 4;
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        if (redundantCanPlaceBlockAt(par1World, par2, par3, par4))
        {
            ...
            if (!par1World.isBlockSolidOnSide(par2 - 1, par3, par4, 5) && i == 1)
            {
                flag = true;
            }

            if (!par1World.isBlockSolidOnSide(par2 + 1, par3, par4, 4) && i == 2)
            {
                flag = true;
            }

            if (!par1World.isBlockSolidOnSide(par2, par3, par4 - 1, 3) && i == 3)
            {
                flag = true;
            }

            if (!par1World.isBlockSolidOnSide(par2, par3, par4 + 1, 2) && i == 4)
            {
                flag = true;
            }
    ...
    public boolean isIndirectlyPoweringTo(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int j = i & 7;
            return j != 5 || par5 != 1 ? j != 4 || par5 != 2 ? j != 3 || par5 != 3 ? j != 2 || par5 != 4 ? j == 1 && par5 == 5 : true : true : true : true;
        }
    }
