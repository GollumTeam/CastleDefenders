...
public class RenderGlobal implements IWorldAccess
{
    ...
    public int sortAndRender(EntityLiving par1EntityLiving, int par2, double par3)
    {
        ...
        if (occlusionEnabled && mc.gameSettings.advancedOpengl && !mc.gameSettings.anaglyph && par2 == 0)
        {
            ...
            k = j + renderSortedRenderers(l, i1, par2, par3);
            ...
            do
            {
                ...
                for (int k1 = byte0; k1 < i1; k1++)
                {
                    ...
                    float f3 = MathHelper.sqrt_float(sortedWorldRenderers[k1].distanceToEntitySquared(par1EntityLiving));
                    ...
                    ARBOcclusionQuery.glBeginQueryARB(ARBOcclusionQuery.GL_SAMPLES_PASSED_ARB, sortedWorldRenderers[k1].glOcclusionQuery);
                ...
                Profiler.endStartSection("render");
                k += renderSortedRenderers(byte0, i1, par2, par3);
            }
        ...
        {
            Profiler.endStartSection("render");
            k = j + renderSortedRenderers(0, sortedWorldRenderers.length, par2, par3);
        }
    ...
    public void renderSky(float par1)
    {
        ...
        else if (mc.theWorld.worldProvider.func_48217_e())
        {
            GL11.glDisable(GL11.GL_TEXTURE_2D);
            ...
            if (mc.gameSettings.anaglyph)
            {
                float f8 = (f * 30F + f1 * 59F + f2 * 11F) / 100F;
                float f3 = (f * 30F + f1 * 70F) / 100F;
            ...
            if (af != null)
            {
                ...
                if (mc.gameSettings.anaglyph)
                {
                    float f15 = (f6 * 30F + f9 * 59F + f12 * 11F) / 100F;
                    float f18 = (f6 * 30F + f9 * 70F) / 100F;
                    float f22 = (f6 * 30F + f12 * 70F) / 100F;
                    f6 = f15;
                    f9 = f18;
                    f12 = f22;
                }
                ...
                tessellator1.setColorRGBA_F(f6, f9, f12, af[3]);
                ...
                for (int j = 0; j <= i1; j++)
                {
                    float f23 = ((float)j * (float)Math.PI * 2.0F) / (float)i1;
                    float f24 = MathHelper.sin(f23);
                    float f20 = MathHelper.cos(f23);
                    tessellator1.addVertex(f24 * 120F, f20 * 120F, -f20 * 40F * af[3]);
                }
            ...
            GL11.glPushMatrix();
            float f4 = 1.0F - worldObj.getRainStrength(par1);
            float f7 = 0.0F;
            float f10 = 0.0F;
            float f13 = 0.0F;
            ...
            int k = worldObj.getMoonPhase(par1);
            int l = k % 4;
            int j1 = (k / 4) % 2;
            float f21 = (float)(l + 0) / 4F;
            ...
            tessellator1.addVertexWithUV(f16, -100D, f16, f21, f27);
            tessellator1.addVertexWithUV(f16, -100D, -f16, f21, f25);
            tessellator1.addVertexWithUV(-f16, -100D, -f16, f26, f25);
            tessellator1.draw();
            GL11.glDisable(GL11.GL_TEXTURE_2D);
            float f19 = worldObj.getStarBrightness(par1) * f4;
            ...
            if (d < 0.0D)
            {
                ...
                tessellator1.addVertex(-f11, f14, f11);
                tessellator1.addVertex(f11, f14, f11);
    ...
    public void renderCloudsFancy(float par1)
    {
        ...
        if (mc.gameSettings.anaglyph)
        {
            ...
            float f11 = (f4 * 30F + f5 * 70F) / 100F;
            float f9 = (f4 * 30F + f6 * 70F) / 100F;
            f4 = f7;
            f5 = f11;
            f6 = f9;
        }
        ...
        f12 = (float)MathHelper.floor_double(d2) * f10;
            ...
            for (int i1 = -byte0 + 1; i1 <= byte0; i1++)
            {
                for (int j1 = -byte0 + 1; j1 <= byte0; j1++)
                {
                    ...
                    if (f3 > -f2 - 1.0F)
                    {
                        ...
                        tessellator.addVertexWithUV(f18 + 0.0F, f3 + 0.0F, f19 + (float)k, (f16 + 0.0F) * f10 + f8, (f17 + (float)k) * f10 + f12);
                        tessellator.addVertexWithUV(f18 + (float)k, f3 + 0.0F, f19 + (float)k, (f16 + (float)k) * f10 + f8, (f17 + (float)k) * f10 + f12);
                        tessellator.addVertexWithUV(f18 + (float)k, f3 + 0.0F, f19 + 0.0F, (f16 + (float)k) * f10 + f8, (f17 + 0.0F) * f10 + f12);
                        tessellator.addVertexWithUV(f18 + 0.0F, f3 + 0.0F, f19 + 0.0F, (f16 + 0.0F) * f10 + f8, (f17 + 0.0F) * f10 + f12);
                    }
                    ...
                    if (f3 <= f2 + 1.0F)
                    {
                        ...
                        tessellator.addVertexWithUV(f18 + 0.0F, (f3 + f2) - f15, f19 + (float)k, (f16 + 0.0F) * f10 + f8, (f17 + (float)k) * f10 + f12);
                        tessellator.addVertexWithUV(f18 + (float)k, (f3 + f2) - f15, f19 + (float)k, (f16 + (float)k) * f10 + f8, (f17 + (float)k) * f10 + f12);
                        tessellator.addVertexWithUV(f18 + (float)k, (f3 + f2) - f15, f19 + 0.0F, (f16 + (float)k) * f10 + f8, (f17 + 0.0F) * f10 + f12);
                        tessellator.addVertexWithUV(f18 + 0.0F, (f3 + f2) - f15, f19 + 0.0F, (f16 + 0.0F) * f10 + f8, (f17 + 0.0F) * f10 + f12);
                    }
                    ...
                    if (i1 > -1)
                    {
                        ...
                        {
                            tessellator.addVertexWithUV(f18 + (float)k1 + 0.0F, f3 + 0.0F, f19 + (float)k, (f16 + (float)k1 + 0.5F) * f10 + f8, (f17 + (float)k) * f10 + f12);
                            tessellator.addVertexWithUV(f18 + (float)k1 + 0.0F, f3 + f2, f19 + (float)k, (f16 + (float)k1 + 0.5F) * f10 + f8, (f17 + (float)k) * f10 + f12);
                            tessellator.addVertexWithUV(f18 + (float)k1 + 0.0F, f3 + f2, f19 + 0.0F, (f16 + (float)k1 + 0.5F) * f10 + f8, (f17 + 0.0F) * f10 + f12);
                            tessellator.addVertexWithUV(f18 + (float)k1 + 0.0F, f3 + 0.0F, f19 + 0.0F, (f16 + (float)k1 + 0.5F) * f10 + f8, (f17 + 0.0F) * f10 + f12);
                        }
                    }
                    ...
                    if (i1 <= 1)
                    {
                        ...
                        {
                            tessellator.addVertexWithUV((f18 + (float)l1 + 1.0F) - f15, f3 + 0.0F, f19 + (float)k, (f16 + (float)l1 + 0.5F) * f10 + f8, (f17 + (float)k) * f10 + f12);
                            tessellator.addVertexWithUV((f18 + (float)l1 + 1.0F) - f15, f3 + f2, f19 + (float)k, (f16 + (float)l1 + 0.5F) * f10 + f8, (f17 + (float)k) * f10 + f12);
                            tessellator.addVertexWithUV((f18 + (float)l1 + 1.0F) - f15, f3 + f2, f19 + 0.0F, (f16 + (float)l1 + 0.5F) * f10 + f8, (f17 + 0.0F) * f10 + f12);
                            tessellator.addVertexWithUV((f18 + (float)l1 + 1.0F) - f15, f3 + 0.0F, f19 + 0.0F, (f16 + (float)l1 + 0.5F) * f10 + f8, (f17 + 0.0F) * f10 + f12);
                        }
                    }
                    ...
                    if (j1 > -1)
                    {
                        ...
                        {
                            tessellator.addVertexWithUV(f18 + 0.0F, f3 + f2, f19 + (float)i2 + 0.0F, (f16 + 0.0F) * f10 + f8, (f17 + (float)i2 + 0.5F) * f10 + f12);
                            tessellator.addVertexWithUV(f18 + (float)k, f3 + f2, f19 + (float)i2 + 0.0F, (f16 + (float)k) * f10 + f8, (f17 + (float)i2 + 0.5F) * f10 + f12);
                            tessellator.addVertexWithUV(f18 + (float)k, f3 + 0.0F, f19 + (float)i2 + 0.0F, (f16 + (float)k) * f10 + f8, (f17 + (float)i2 + 0.5F) * f10 + f12);
                            tessellator.addVertexWithUV(f18 + 0.0F, f3 + 0.0F, f19 + (float)i2 + 0.0F, (f16 + 0.0F) * f10 + f8, (f17 + (float)i2 + 0.5F) * f10 + f12);
                        }
                    }
                    ...
                    if (j1 <= 1)
                    {
                        ...
                        {
                            tessellator.addVertexWithUV(f18 + 0.0F, f3 + f2, (f19 + (float)j2 + 1.0F) - f15, (f16 + 0.0F) * f10 + f8, (f17 + (float)j2 + 0.5F) * f10 + f12);
                            tessellator.addVertexWithUV(f18 + (float)k, f3 + f2, (f19 + (float)j2 + 1.0F) - f15, (f16 + (float)k) * f10 + f8, (f17 + (float)j2 + 0.5F) * f10 + f12);
                            tessellator.addVertexWithUV(f18 + (float)k, f3 + 0.0F, (f19 + (float)j2 + 1.0F) - f15, (f16 + (float)k) * f10 + f8, (f17 + (float)j2 + 0.5F) * f10 + f12);
                            tessellator.addVertexWithUV(f18 + 0.0F, f3 + 0.0F, (f19 + (float)j2 + 1.0F) - f15, (f16 + 0.0F) * f10 + f8, (f17 + (float)j2 + 0.5F) * f10 + f12);
                        }
                    }
    ...
    public boolean updateRenderers(EntityLiving par1EntityLiving, boolean par2)
    {
        ...
        for (int j1 = 0; j1 < l; j1++)
        {
            ...
            if (!par2)
            {
                if (worldrenderer1.distanceToEntitySquared(par1EntityLiving) > 256F)
                {
                    ...
                    for (i2 = 0; i2 < byte0 && (aworldrenderer[i2] == null || rendersorter.doCompare(aworldrenderer[i2], worldrenderer1) <= 0); i2++) { }
                    ...
                    do
                    {
                        if (--k2 == 0)
                        {
                            aworldrenderer[i2] = worldrenderer1;
                            continue label0;
                        }

                        aworldrenderer[k2 - 1] = aworldrenderer[k2];
                    }
                    while (true);
                }
            }
            ...
            worldRenderersToUpdate.set(j1, (Object)null);
        }
        ...
        for (int i3 = byte0 - 1; i3 >= 0; i3--)
        {
            WorldRenderer worldrenderer3 = aworldrenderer[i3];
            ...
            if (!worldrenderer3.isInFrustum && i3 != byte0 - 1)
            {
                aworldrenderer[i3] = null;
                aworldrenderer[0] = null;
                break;
            }

            aworldrenderer[i3].updateRenderer();
            aworldrenderer[i3].needsUpdate = false;
            l1++;
        }
        ...
        for (int l2 = worldRenderersToUpdate.size(); j3 != l2; j3++)
        {
            WorldRenderer worldrenderer4 = (WorldRenderer)worldRenderersToUpdate.get(j3);
            ...
            if (j2 != j3)
            {
                worldRenderersToUpdate.set(j2, worldrenderer4);
            }
        ...
        do
        {
            ...
            worldRenderersToUpdate.remove(j3);
        }
        while (true);
    }
    ...
    public EntityFX func_40193_b(String par1Str, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        if (mc != null && mc.renderViewEntity != null && mc.effectRenderer != null)
        {
            ...
            else if (par1Str.startsWith("tilecrack_"))
            {
                ...
                obj1 = Block.blocksList[k];
            }

            if (obj != null)
            {
                mc.effectRenderer.addEffect(((EntityFX)(obj)), obj1);
            }
    ...
    public void playAuxSFX(EntityPlayer par1EntityPlayer, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        switch (par2)
        {
            ...
            case 1005:
                ...
                {
                    worldObj.playRecord((String)null, par3, par4, par5);
                }
            ...
            case 2000:
                ...
                double d3 = (double)par4 + 0.5D;
                double d18 = (double)par5 + (double)k1 * 0.59999999999999998D + 0.5D;

                for (int l1 = 0; l1 < 10; l1++)
                {
                    double d19 = random.nextDouble() * 0.20000000000000001D + 0.01D;
                    double d20 = d + (double)i * 0.01D + (random.nextDouble() - 0.5D) * (double)k1 * 0.5D;
                    double d6 = d3 + (random.nextDouble() - 0.5D) * 0.5D;
                    double d8 = d18 + (double)k1 * 0.01D + (random.nextDouble() - 0.5D) * (double)i * 0.5D;
                    double d10 = (double)i * d19 + random.nextGaussian() * 0.01D;
                    double d12 = -0.029999999999999999D + random.nextGaussian() * 0.01D;
                    double d14 = (double)k1 * d19 + random.nextGaussian() * 0.01D;
                    spawnParticle("smoke", d20, d6, d8, d10, d12, d14);
                }
            ...
            case 2002:
                ...
                double d1 = par4;
                double d4 = par5;
                String s = (new StringBuilder()).append("iconcrack_").append(Item.potion.shiftedIndex).toString();

                for (int l = 0; l < 8; l++)
                {
                    spawnParticle(s, d16, d1, d4, random.nextGaussian() * 0.14999999999999999D, random.nextDouble() * 0.20000000000000001D, random.nextGaussian() * 0.14999999999999999D);
                }
                ...
                {
                    double d7 = random.nextDouble() * 4D;
                    double d9 = random.nextDouble() * Math.PI * 2D;
                    double d11 = Math.cos(d9) * d7;
                    double d13 = 0.01D + random.nextDouble() * 0.5D;
                    double d15 = Math.sin(d9) * d7;
                    EntityFX entityfx = func_40193_b(s2, d16 + d11 * 0.10000000000000001D, d1 + 0.29999999999999999D, d4 + d15 * 0.10000000000000001D, d11, d13, d15);
            ...
            case 2003:
                double d17 = (double)par3 + 0.5D;
                double d2 = par4;
                double d5 = (double)par5 + 0.5D;
                String s1 = (new StringBuilder()).append("iconcrack_").append(Item.eyeOfEnder.shiftedIndex).toString();

                for (int j1 = 0; j1 < 8; j1++)
                {
                    spawnParticle(s1, d17, d2, d5, random.nextGaussian() * 0.14999999999999999D, random.nextDouble() * 0.20000000000000001D, random.nextGaussian() * 0.14999999999999999D);
                }

                for (double d21 = 0.0D; d21 < (Math.PI * 2D); d21 += 0.15707963267948966D)
                {
                    spawnParticle("portal", d17 + Math.cos(d21) * 5D, d2 - 0.40000000000000002D, d5 + Math.sin(d21) * 5D, Math.cos(d21) * -5D, 0.0D, Math.sin(d21) * -5D);
                    spawnParticle("portal", d17 + Math.cos(d21) * 5D, d2 - 0.40000000000000002D, d5 + Math.sin(d21) * 5D, Math.cos(d21) * -7D, 0.0D, Math.sin(d21) * -7D);
                }
            ...
            case 2004:
                for (int k = 0; k < 20; k++)
                {
                    double d22 = (double)par3 + 0.5D + ((double)worldObj.rand.nextFloat() - 0.5D) * 2D;
                    double d23 = (double)par4 + 0.5D + ((double)worldObj.rand.nextFloat() - 0.5D) * 2D;
                    double d24 = (double)par5 + 0.5D + ((double)worldObj.rand.nextFloat() - 0.5D) * 2D;
                    worldObj.spawnParticle("smoke", d22, d23, d24, 0.0D, 0.0D, 0.0D);
                    worldObj.spawnParticle("flame", d22, d23, d24, 0.0D, 0.0D, 0.0D);
                }
