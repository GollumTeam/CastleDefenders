...
public class BlockRedstoneRepeater extends BlockDirectional
{
    ...
    {
        return par1World.isBlockSolidOnSide(par2, par3 - 1, par4, 1) ? super.canPlaceBlockAt(par1World, par2, par3, par4) : false;
    }
    ...
    {
        return par1World.isBlockSolidOnSide(par2, par3 - 1, par4, 1) ? super.canBlockStay(par1World, par2, par3, par4) : false;
    }
    ...
    {
        return par1 != 0 ? par1 != 1 ? 5 : isRepeaterPowered ? 147 : '\203' : isRepeaterPowered ? 'c' : 115;
    }
    ...
    public boolean isPoweringTo(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        else
        {
            ...
            return i != 0 || par5 != 3 ? i != 1 || par5 != 4 ? i != 2 || par5 != 2 ? i == 3 && par5 == 5 : true : true : true;
        }
    }
