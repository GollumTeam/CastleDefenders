...
public class TileEntityRenderer
{
    ...
    {
        return par1TileEntity != null ? getSpecialRendererForClass(par1TileEntity.getClass()) : null;
    }
    ...
    public static void setTileEntityRenderer(Class class1, TileEntitySpecialRenderer tileentityspecialrenderer)
    {
        instance.specialRendererMap.put(class1, tileentityspecialrenderer);
        tileentityspecialrenderer.setTileEntityRenderer(instance);
    }
}
