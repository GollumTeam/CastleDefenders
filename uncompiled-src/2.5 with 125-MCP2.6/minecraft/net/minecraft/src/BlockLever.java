...
public class BlockLever extends Block
{
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        if (checkIfAttachedToBlock(par1World, par2, par3, par4))
        {
            ...
            if (!par1World.isBlockSolidOnSide(par2, par3 - 1, par4, 1) && i == 5)
            {
                flag = true;
            }

            if (!par1World.isBlockSolidOnSide(par2, par3 - 1, par4, 1) && i == 6)
            {
                flag = true;
            }
    ...
    public boolean isIndirectlyPoweringTo(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int j = i & 7;
            return j != 6 || par5 != 1 ? j != 5 || par5 != 1 ? j != 4 || par5 != 2 ? j != 3 || par5 != 3 ? j != 2 || par5 != 4 ? j == 1 && par5 == 5 : true : true : true : true : true;
        }
    }
