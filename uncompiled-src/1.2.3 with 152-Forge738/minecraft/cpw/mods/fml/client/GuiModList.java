...
public class GuiModList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        for (Iterator var1 = this.mods.iterator(); var1.hasNext(); this.listWidth = Math.max(this.listWidth, this.getFontRenderer().getStringWidth(var2.getVersion()) + 10))
        {
            var2 = (ModContainer)var1.next();
            this.listWidth = Math.max(this.listWidth, this.getFontRenderer().getStringWidth(var2.getName()) + 10);
        }

        this.listWidth = Math.min(this.listWidth, 150);
        StringTranslate var3 = StringTranslate.getInstance();
        this.buttonList.add(new GuiSmallButton(6, this.width / 2 - 75, this.height - 38, var3.translateKey("gui.done")));
    ...
    {
        this.fontRenderer.drawString(var1, var2, var3, 14151146);
        return var3 + 10;
    }
        ...
        if (this.selectedMod != null)
        {
            ...
            if (!this.selectedMod.getMetadata().autogenerated)
            {
                ...
                if (!var6.isEmpty())
                {
                    ...
                    var15.addVertexWithUV((double)var4, (double)(var14 + var7.height), (double)this.zLevel, 0.0D, 1.0D);
                    var15.addVertexWithUV((double)(var4 + var7.width), (double)(var14 + var7.height), (double)this.zLevel, 1.0D, 1.0D);
                    var15.addVertexWithUV((double)(var4 + var7.width), (double)var14, (double)this.zLevel, 1.0D, 0.0D);
                    var15.addVertexWithUV((double)var4, (double)var14, (double)this.zLevel, 0.0D, 0.0D);
                    var15.draw();
                    var5 += 65;
                }

                this.fontRenderer.drawStringWithShadow(this.selectedMod.getMetadata().name, var4, var5, 16777215);
                var5 += 12;
                ...
                if (var16 > 20)
                {
                    this.getFontRenderer().drawSplitString(this.selectedMod.getMetadata().description, var4, var5 + 10, var16, 14540253);
                }
            }
            else
            {
